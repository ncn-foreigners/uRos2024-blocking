...
birthdate_attr = generator.GenerateFuncAttribute(
    ...
    #Parametry do funkcji generowania dat urodzenia:
    ...
    #format : String : format in which birthdate should be generated. Options -> ["MM/DD/YYYY", "DD/MM/YYYY", "YYYY/MM/DD"]
...
edit_corruptor3 = corruptor.CorruptValueEdit(
          position_function = corruptor.position_mod_normal,
          char_set_funct = basefunctions.char_set_ascii,
          insert_prob = 0.0,
          delete_prob = 0.5,
...
missing_val_corruptor_2 = corruptor.CorruptMissingValue(
       missing_val='puste'
)
...
attr_mod_data_dictionary = {
    ...
    'second_name': [(0.8, polish_letters_corruptor), (0.2, keyboard_corruptor)],
    'last_name': [(0.8, polish_letters_corruptor), (0.2, missing_val_corruptor_2)],
    'region': [(1.0, missing_val_corruptor)],
    'birth_date': [(0.5, birthday_year_corruptor), (0.5, missing_val_corruptor)],
...
```{python}
def generate_dataframes(data_generator, data_corruptor, num_sim=5, path=None, corrupt_name_args=['switch', 0.1, 0, 1, 2]):
